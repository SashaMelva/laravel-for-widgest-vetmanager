<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" style="display: grid; grid-template-columns: 1fr 2fr;">
                ...
                <div class="p-6">
                    <div class="mt-1 mb-4">
                        <a class="inline-flex items-center px-4 py-2 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
                           style="background-color: rgb(30 41 59);"
                           href="{{route('add-client')}}" hidden="hidden">{{ __('Add Pet') }}</a>
                    </div>
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tr class="bg-gray-50">
                                ...
                                <th scope="col" class="px-6 py-5">Возраст</th>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-5">Дуся</td>
                                <td class="px-6 py-5">Собака</td>
                                <td class="px-6 py-5">10.09.2019</td>
                                <td class="px-6 py-5">
                                    <a href="">Edit</a>
                                </td>
                                <td class="px-6 py-5">
