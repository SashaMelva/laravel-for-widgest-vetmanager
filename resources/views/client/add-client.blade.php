                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                ...
                                id="lastName" name="lastName" type="text" placeholder="last name" @if(!is_null($client)) value="{{ $client->lastName }}"@endif>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                id="firstName" name="firstName" type="text" placeholder="first name" @if(!is_null($client)) value="{{ $client->firstName }}"@endif>
                            <p class="text-red-500 text-xs italic">Please fill out this field.</p>
                        </div>
                        <div class="w-full md:w-1/2 px-3">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            ...
                            <input
                                ...
                                id="middleName" name="middleName" type="text" placeholder="middle name" @if(!is_null($client)) value="{{ $client->middleName }}"@endif>
                        </div>
                    </div>
